...
\title{	
   ...
   \huge Lab 2 -- ~Lexer \\     	    % Assignment title
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../assets/dfa-a.png}
    \caption{Problem A)}
  \label{fig:dfa-a}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../assets/dfa-b2.png}
    \caption{Problem B)}
  \label{fig:dfa-b2}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../assets/dfa-c.png}
    \caption{Problem C)}
  \label{fig:dfa-c}
\end{figure}
\section{Dragon}
